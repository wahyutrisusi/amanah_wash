...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark shadow fixed-top">
    <div class="container">
        ...
        <a class="navbar-brand fw-bold d-flex align-items-center" href="{{ route('beranda') }}">
            <img src="https://i2.wp.com/diajengwitri.id/wp-content/uploads/2019/06/Modifikasi-Motor-di-Moladin.png" 
                alt="Amanah Wash Logo" style="height: 40px;">
            <span class="ms-2">AMANAH WASH</span>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs('layanan') ? 'active' : '' }}" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown">
                        Layanan
                    </a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('layanan') }}">Layanan Motor</a></li>
                        <li><a class="dropdown-item" href="{{ route('layanan') }}">Layanan Karpet</a></li>
                    </ul>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('pemesanan') ? 'active' : '' }}" href="{{ route('pemesanan') }}">Pemesanan</a>
                </li>
                <li class="nav-item">
